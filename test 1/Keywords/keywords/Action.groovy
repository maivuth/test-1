...
class Action {
	...
	@Keyword
	def enterAppointmentInfo(String HealthcareCenter, String Comment = '') {
	...
	def inputLogin (String username, String passwordEncrypted) {
		WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username_username'), username)

		WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'), passwordEncrypted)

		WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Login'))
		//String decodedpassword = CryptoUtil.decode(passwordEncrypted)
	}

	def encodeValue(String inputText) {
		//Must import com.kms.katalon.util.CryptoUtil
		String encodedpassword = CryptoUtil.encode(CryptoUtil.getDefault(inputText))
		return encodedpassword
	}

	def decodeValue(String encryptedText) {
		//Must import com.kms.katalon.util.CryptoUtil
		String decodedpassword = CryptoUtil.decode(CryptoUtil.getDefault(encryptedText))

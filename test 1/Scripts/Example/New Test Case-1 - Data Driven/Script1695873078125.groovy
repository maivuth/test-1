...
import keywords.Action as Action
...
WebUI.click(findTestObject('Page_Appointment_Data/rad_programs', [('program') : 'Medicaid']))
...
//
//WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Non')
//
//WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Book Appointment'))
//
//WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Appointment Confirmation'), 
//    10)
